...
namespace OOPenaltyPoints.Controllers
{
    public class DriverOffenceController : Controller
    {
        ...
        {
            if (index == 1)
                //return View(_BLL.NewOffenceNotification());
                return View();
            else if (index == 2)
                //return View(_BLL.A28DaysNotification());
                return View();
            else if (index == 3)
                //return View(_BLL.A56DaysNotification());
                return View();
            else if (index == 4)
    ...
    public class DriverOffenceController : Controller
    {
        ...
        public ActionResult DailyTasksComplete(int index)
        {
            if (index == 1)
                ...
                //return View(_BLL.DisqualificationNotification());
                return View();
            else if (index == 5)
                //return View(_BLL.A3YearDeleteNotification());
                return View();
            else if (index == 6)
                return View();
